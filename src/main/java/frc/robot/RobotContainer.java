...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        m_chooser.setDefaultOption("No drive Auto", (AutoArmRaiseCommand2.withTimeout(2)).andThen(AutoEjectCommand2).andThen(AutoArmLowerCommand2.withTimeout(2.8)));
        m_chooser.addOption("Full Auto Balance", (AutoArmRaiseCommand3.withTimeout(2)).andThen(AutoEjectCommand3).andThen(AutoArmLowerCommand3.withTimeout(2.8)).andThen(AutoBalanceCommand)); //AutoDriveCommand
        m_chooser.addOption("Full Auto Drive Far", (AutoArmRaiseCommand.withTimeout(2)).andThen(AutoEjectCommand).andThen(AutoArmLowerCommand.withTimeout(2.8)).andThen(AutoDriveCommand)); //AutoDriveCommand
